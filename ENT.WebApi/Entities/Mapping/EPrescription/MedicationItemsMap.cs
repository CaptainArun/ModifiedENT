...
{
    public class MedicationItemsMap : IEntityTypeConfiguration<MedicationItems>
    {
        public void Configure(EntityTypeBuilder<MedicationItems> builder)
        {
            builder.ToTable("MedicationItems", "dbo");
            builder.HasKey(x => x.MedicationItemsId);

            builder.Property(x => x.MedicationItemsId).HasColumnName("MedicationItemsId");
