...
{
    public class OAETestMap : IEntityTypeConfiguration<OAETest>
    {
        public void Configure(EntityTypeBuilder<OAETest> builder)
        {
            builder.ToTable("OAETest", "dbo");
            builder.HasKey(x => x.OAETestId);

            builder.Property(x => x.OAETestId).HasColumnName("OAETestId");
