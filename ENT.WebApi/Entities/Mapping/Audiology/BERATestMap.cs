...
{
    public class BERATestMap : IEntityTypeConfiguration<BERATest>
    {
        public void Configure(EntityTypeBuilder<BERATest> builder)
        {
            builder.ToTable("BERATest", "dbo");
            builder.HasKey(x => x.BERATestId);

            builder.Property(x => x.BERATestId).HasColumnName("BERATestId");
