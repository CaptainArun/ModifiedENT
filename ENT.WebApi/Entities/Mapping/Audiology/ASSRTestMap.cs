...
{
    public class ASSRTestMap : IEntityTypeConfiguration<ASSRTest>
    {
        public void Configure(EntityTypeBuilder<ASSRTest> builder)
        {
            builder.ToTable("ASSRTest", "dbo");
            builder.HasKey(x => x.ASSRTestId);

            builder.Property(x => x.ASSRTestId).HasColumnName("ASSRTestId");
