...
{
    public class TinnitusmaskingMap : IEntityTypeConfiguration<Tinnitusmasking>
    {
        public void Configure(EntityTypeBuilder<Tinnitusmasking> builder)
        {
            builder.ToTable("Tinnitusmasking", "dbo");
            builder.HasKey(x => x.TinnitusmaskingId);

            builder.Property(x => x.TinnitusmaskingId).HasColumnName("TinnitusmaskingId");
