import { MedicationRequestItemsModel } from "./medicationRequestItemsModel";

export class MedicationRequestsModel {
    ...
    public medicationRequestItems: MedicationRequestItemsModel[];
}